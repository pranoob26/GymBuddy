...
const Cfgym = ({ navigation }) => {
  const [personaltrainergym, setpersonaltrainergym] = useState([]);
  const ptgyms = firebase.firestore().collection("Cfgym");
  ...
  const navigateToDetail = (gymId) => {
    navigation.navigate("GymDetailPage3", { gymId });
  };
  ...
  return (
    <SafeAreaView style={styles.ptpage}>
      ...
      <View>
        <Text style={styles.pttext}>CROSS FIT GYMS</Text>
      </View>
      <TextInput

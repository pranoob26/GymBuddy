...
const Bgym = ({ navigation }) => {
  const [personaltrainergym, setpersonaltrainergym] = useState([]);
  const ptgyms = firebase.firestore().collection("Bgym");
  ...
  const navigateToDetail = (gymId) => {
    navigation.navigate("GymDetailPage4", { gymId });
  };
  ...
  return (
    <SafeAreaView style={styles.ptpage}>
      ...
      <View>
        <Text style={styles.pttext}>BOUTIQUE GYMS</Text>
      </View>
      <TextInput
